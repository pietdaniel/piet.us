...
$(document).ready(function() {
  fetchOnload("js/countdown.js");
  fetchOnload("js/ThreeSound.js");
  fetchOnload("js/three.min.js");
  fetchOnload("js/OrbitControls.js");
  fetchOnload("js/Mirror.js");
  fetchOnload("js/WaterShader.js");
  fetchOnload("js/Detector.js");
  fetchOnload("js/stats.min.js");
  ...
  $('#countdown').hide();
  $('#weird').hide()
  $('#countdown').aTime({"font-size" : "16px"});

  var linkSelector=Math.floor(Math.random()*10%4);
